...
Class NSTheme
    ...
    Sub New()
        ...
        P2 = New Pen(Color.FromArgb(45, 45, 45))

        B1 = New SolidBrush(Color.FromArgb(0, 190, 160))
    End Sub
    ...
    Protected Overrides Sub PaintHook()
        ...
        G.DrawLine(P1, 0, 36, Width, 36)
        G.DrawLine(P2, 0, 35, Width, 35)
...
Class NSButton
    ...
    Protected Overrides Sub OnPaint(e As System.Windows.Forms.PaintEventArgs)
        ...
        GP1 = CreateRound(0, 0, Width - 1, Height - 1, 1)
        GP2 = CreateRound(1, 1, Width - 3, Height - 3, 1)
        ...
        If IsMouseDown Then
            ...
            G.FillPath(PB1, GP1)
        Else
            GB1 = New LinearGradientBrush(ClientRectangle, Color.FromArgb(0, 190, 190), Color.FromArgb(55, 55, 55), 45.0F)
            G.FillPath(GB1, GP1)
        End If
...
Class NSCheckBox
    ...
    Sub New()
        ...
        P4 = New Pen(Color.FromArgb(0, 190, 190), 2.0F)
    End Sub
...
Class NSRadioButton
    ...
    Protected Overrides Sub OnPaint(e As System.Windows.Forms.PaintEventArgs)
        ...
        If _Checked Then
            ...
            G.FillEllipse(New SolidBrush(Color.FromArgb(0, 190, 190)), 5, 7, Height - 15, Height - 15)
        End If
...
Class NSTabControl
    ...
    Sub New()
        ...
        ItemSize = New Size(122, 35)

        DrawMode = TabDrawMode.Normal

        P1 = New Pen(Color.FromArgb(80, 80, 80))
        P2 = New Pen(Color.FromArgb(60, 60, 60))
        P3 = New Pen(Color.FromArgb(45, 45, 45), 2)
        P4 = New Pen(Color.FromArgb(45, 145, 145), 1)

        B1 = NoiseBrush({Color.FromArgb(32, 32, 32), Color.FromArgb(40, 40, 40), Color.FromArgb(24, 24, 24)})
        B2 = NoiseBrush({Color.FromArgb(80, 80, 80), Color.FromArgb(56, 52, 49), Color.FromArgb(58, 55, 51)})
        B3 = NoiseBrush({Color.FromArgb(25, 110, 165), Color.FromArgb(45, 145, 145), Color.FromArgb(58, 55, 51)})
        B4 = NoiseBrush({Color.FromArgb(180, 180, 180), Color.FromArgb(156, 152, 149), Color.FromArgb(158, 155, 151)})
    ...
    Protected Overrides Sub OnControlAdded(e As ControlEventArgs)
        If TypeOf e.Control Is TabPage Then
            ...
            'G.FillRectangle(Brushes.Black, e.Control.ClientRectangle)
        End If
    ...
    Private P1, P2, P3, P4 As Pen
    Private B1, B2, B3, B4 As TextureBrush
    Private PB1 As PathGradientBrush
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        GP1 = CreateRound(0, 0, Width, ItemSize.Height, 1)
        GP2 = CreateRound(1, 1, ItemHeight + 3, Height - 3, 1)
        ...
        For I As Integer = 0 To TabCount - 1
            ...
            If SelectedIndex = I Then
                ...
                For J As Integer = 0 To 1
                    ...
                    G.SmoothingMode = SmoothingMode.AntiAlias
                    G.FillRectangle(Brushes.Teal, New Rectangle(R1.X + 20, R1.Y + ItemSize.Height / 4.0F, ItemSize.Height / 2.0F, ItemSize.Height / 2.0F))
                    G.DrawRectangle(Pens.Black, New Rectangle(R1.X + 20, R1.Y + ItemSize.Height / 4.0F, ItemSize.Height / 2.0F, ItemSize.Height / 2.0F))
                    G.FillEllipse(New SolidBrush(Color.White), New Rectangle(R1.X + 15 + ItemSize.Height / 4.0F, R1.Y + 2 + ItemSize.Height / 3.0F, ItemSize.Height / 4.0F, ItemSize.Height / 4.0F))
                    G.DrawEllipse(Pens.Black, New Rectangle(R1.X + 15 + ItemSize.Height / 4.0F, R1.Y + 2 + ItemSize.Height / 3.0F, ItemSize.Height / 4.0F, ItemSize.Height / 4.0F))

                    'G.FillEllipse(Brushes.Teal, R1.X + 15 + (J * 5), R1.Y + 15, 12, 12)
                    'G.DrawEllipse(New Pen(Color.FromArgb(40, 40, 40)), R1.X + 15 + (J * 5), R1.Y + 15, 12, 12)
                    ' G.FillEllipse(Brushes.OrangeRed, New Rectangle(15, 15, 10, 10))
                    'G.DrawLine(P4, R1.X + 1, R1.Y - 1, R1.Width, R1.Height + 2)
                    Offset += 5
                Next

                'G.DrawRectangle(P4, R1.X + 1, R1.Y - 1, R1.Width, R1.Height)
                ' G.DrawLine(P4, R1.X + 1, R1.Y - 1, R1.Width, R1.Height + 2)
            Else
                For J As Integer = 0 To 1

                    G.FillRectangle(B1, R1.X + 5 + (J * 5), R1.Y + 6, 2, R1.Height - 9)
        ...
        GP3 = CreateRound(0, 0, Width - 1, Height - 1, 1)

        G.DrawPath(P2, GP3)
        G.DrawLine(P1, 1, 1, Width - 2, 1)
        G.DrawLine(P2, 1, ItemHeight, Width - 2, ItemHeight)
        G.DrawRectangle(Pens.Black, Me.ClientRectangle.X, Me.ClientRectangle.Y, Me.ClientRectangle.Width - 2, Me.ClientRectangle.Height - 2)
    End Sub
...
Class NSOnOffBox
    ...
    Sub New()
        ...
        B4 = New SolidBrush(Color.FromArgb(0, 190, 190))
...
Class NSControlButton
    ...
    Public Property ControlButton() As Button
        ...
        End Set
    End Property
    Private _MinimizeColor As Color
    ...
    Property CloseColor As Color
        ...
        End Set
    End Property
    Private _MaximizeColor As Color
    ...
    Sub New()
        ...
        _MinimizeColor = Color.Teal
        _CloseColor = Color.Maroon
    End Sub
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Dim BorderPen As Pen = New Pen(Color.FromArgb(60, 60, 60))
        Select Case _ControlButton
            Case Button.Minimize
                Select Case State
                    Case MouseState.Down
                        _MinimizeColor = Color.FromArgb(45, 45, 45)
                    Case Else
                End Select
                G.FillRectangle(New SolidBrush(_MinimizeColor), ClientRectangle)
                G.SmoothingMode = SmoothingMode.HighQuality
                G.FillEllipse(Brushes.Honeydew, 5, 5, 15, 15)
                G.DrawEllipse(BorderPen, 5, 5, 15, 15)
            Case Button.MaximizeRestore
                ...
                If FindForm().WindowState = FormWindowState.Normal Then
                    G.FillRectangle(New SolidBrush(_MaximizeColor), ClientRectangle)
                    G.SmoothingMode = SmoothingMode.HighQuality
                    G.FillEllipse(Brushes.Honeydew, 5, 5, 15, 15)
                    G.DrawEllipse(Pens.Black, 5, 5, 15, 15)
                Else
                    G.FillRectangle(New SolidBrush(_MaximizeColor), ClientRectangle)
                    G.SmoothingMode = SmoothingMode.HighQuality
                    G.FillEllipse(Brushes.YellowGreen, 5, 5, 15, 15)
                    G.DrawEllipse(Pens.Black, 5, 5, 15, 15)
                End If
            Case Button.Close
                Select Case State
                    ...
                    Case Else
                End Select
                G.FillRectangle(New SolidBrush(_CloseColor), ClientRectangle)
                G.SmoothingMode = SmoothingMode.HighQuality
                G.FillEllipse(Brushes.Ivory, 5, 5, 15, 15)
                G.DrawEllipse(BorderPen, 5, 5, 15, 15)
        End Select
    ...
    Private Sub DrawClose(ByVal x As Integer, ByVal y As Integer)
        G.SmoothingMode = SmoothingMode.HighQuality
        G.FillEllipse(New SolidBrush(_CloseColor), 0, 0, Height - 2, Height - 2)
        G.DrawEllipse(Pens.Black, 0, 0, Height - 2, Height - 2)
    End Sub
...
Class NSRandomPool
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        PB1 = New PathGradientBrush(GP1)
        PB1.CenterColor = Color.FromArgb(32, 32, 32)
        PB1.SurroundColors = {Color.FromArgb(45, 45, 45)}
        PB1.FocusScales = New PointF(0.9F, 0.5F)
...
Class NSListBox : Inherits ListBox
#Region "Properties"
    Sub New()
    ...
    End Sub
    Dim HoverTexture As TextureBrush = NoiseBrush({BackColor, Color.FromArgb(32, 32, 32), Color.FromArgb(50, 46, 42)})
...
#Region "Color of Control"
    Protected Overrides Sub OnDrawItem(ByVal e As DrawItemEventArgs)
        ...
        If e.State.ToString().Contains("Selected,") Then
            Dim MainBody As New LinearGradientBrush(New Rectangle(e.Bounds.X, e.Bounds.Y, e.Bounds.Width, e.Bounds.Height), Color.FromArgb(25, 25, 25), Color.FromArgb(50, 50, 50), 270S)
            G.FillRectangle(HoverTexture, New Rectangle(e.Bounds.X, e.Bounds.Y + 1, e.Bounds.Width, e.Bounds.Height))
            G.DrawRectangle(New Pen(Color.FromArgb(32, 32, 32)), New Rectangle(e.Bounds.X, e.Bounds.Y, e.Bounds.Width, e.Bounds.Height))
            Dim HeaderHatch As New HatchBrush(HatchStyle.Divot, Color.FromArgb(40, 40, 40), Color.FromArgb(45, 45, 45))
            G.FillRectangle(HeaderHatch, New Rectangle(e.Bounds.X, e.Bounds.Y + 1, e.Bounds.Width, e.Bounds.Height))
            G.DrawRectangle(New Pen(Color.FromArgb(32, 32, 32)), New Rectangle(e.Bounds.X, e.Bounds.Y + 1, e.Bounds.Width, e.Bounds.Height))
            'G.FillRectangle(HoverTexture, New Rectangle(e.Bounds.X, e.Bounds.Y + 1, e.Bounds.Width, e.Bounds.Height - 8))
        Else
            G.FillRectangle(New SolidBrush(BackColor), e.Bounds)
            'G.DrawRectangle(New Pen(Color.FromArgb(32, 32, 32)), e.Bounds)
        End If

        Try
            ' put a space cuz the text will stick into the left
            G.DrawString(" " & Items(e.Index).ToString(), Font, New SolidBrush(ForeColor), e.Bounds.X, e.Bounds.Y + 3)
            'G.DrawString(" " & Items(e.Index).ToString(), Font, New SolidBrush(ForeColor), e.Bounds.X, e.Bounds.Y + 1)
        Catch : End Try
        G.DrawRectangle(New Pen(Color.FromArgb(20, 20, 20)), New Rectangle(1, 1, Width - 3, Height - 3))
        G.DrawRectangle(New Pen(Color.FromArgb(50, 50, 50)), New Rectangle(0, 0, Width - 1, Height - 1))

        G.DrawLine(New Pen(Color.FromArgb(90, 90, 90)), Width - 1, 5, Width - 1, Height)
        G.DrawLine(New Pen(Color.FromArgb(90, 90, 90)), 5, Height - 1, Width, Height - 1)
        MyBase.OnDrawItem(e)
    End Sub
#End Region
End Class
