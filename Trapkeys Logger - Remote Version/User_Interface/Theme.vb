...
Public Class xVisualTheme : Inherits ContainerControl
    ...
    Dim TopTexture As TextureBrush = NoiseBrush({Color.FromArgb(32, 32, 32), Color.FromArgb(40, 40, 40), Color.FromArgb(24, 24, 24)})
    Dim InnerTexture As TextureBrush = NoiseBrush({Color.FromArgb(60, 60, 60), Color.FromArgb(56, 52, 49), Color.FromArgb(58, 55, 51)})
    Dim drawFont As New Font("Candara", 12, FontStyle.Bold)
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        Dim mainGradient As TextureBrush = NoiseBrush({Color.FromArgb(32, 32, 32), Color.FromArgb(40, 40, 40), Color.FromArgb(24, 24, 24)})
        ...
        G.DrawIcon(ParentForm.Icon, New Rectangle(32, 10, 32, 32))
        'G.DrawRectangle(New Pen(Color.FromArgb(80, 80, 80)), New Rectangle(32, 6, 40, 40))
        G.DrawString(Text, drawFont, New SolidBrush(Color.FromArgb(255, 255, 255)), New Rectangle(80, 20, Width, 37), New StringFormat() With {.Alignment = StringAlignment.Near, .LineAlignment = StringAlignment.Near})
...
#End Region
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        Dim ControlTopCircle As New LinearGradientBrush(New Rectangle(13, 6, 9, 9), Color.FromArgb(230, 80, 80), Color.FromArgb(230, 100, 100), 90S)
        ...
        Dim NControlBottomCircle As New LinearGradientBrush(New Rectangle(13, 12, 9, 5), Color.FromArgb(95, 95, 95), Color.FromArgb(155, 165, 174), 90S)
...
None:
                ...
                If X > 10 And X < 25 Then
                ElseIf X > 33 And X < 48 Then
                    Dim ControlTopCircle1 As New LinearGradientBrush(New Rectangle(13, 6, 9, 9), Color.FromArgb(255, 255, 255), Color.FromArgb(230, 100, 100), 90S)
                    G.FillEllipse(ControlTopCircle1, New Rectangle(36, 4, 9, 7)) 'Top Circle

                ElseIf X > 56 And X < 71 Then
                    Dim ControlTopCircle1 As New LinearGradientBrush(New Rectangle(13, 6, 9, 9), Color.FromArgb(230, 80, 80), Color.FromArgb(230, 100, 100), 90S)
                    G.FillEllipse(ControlTopCircle1, New Rectangle(59, 4, 9, 7)) 'Top Circle
...
#End Region
    ...
    Property TextColor As Color
        ...
        End Set
    End Property
    Private _RoundRadius As Double
    <Category("RoundingRadius")> _
    Property RoundingRadius As Double
        Get
            Return _RoundRadius
        End Get
        Set(value As Double)
    ...
    Sub New()
        ...
        DoubleBuffered = True
        _BaseColor = Color.FromArgb(24, 24, 24)
    End Sub
    Dim InnerTexture As SolidBrush = New SolidBrush(_BaseColor)
    Dim HoverTexture As TextureBrush = NoiseBrush({_BaseColor, Color.FromArgb(32, 32, 32), Color.FromArgb(50, 46, 42)})
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        Dim B As New Bitmap(Width, Height)
        Dim G As Graphics = Graphics.FromImage(B)
        ...
        Select Case _Shade
            Case InnerShade.Dark
                ...
                Dim TextBrush As SolidBrush = New SolidBrush(_TextColor)
                Dim _Font As New Font("Candara", 10, FontStyle.Regular)
                Select Case State
                    Case MouseState.None
                        G.FillPath(HoverTexture, Draw.CreateRound(ClientRectangle, 3))
                        G.DrawString(Text, _Font, TextBrush, New Rectangle(0, 0, Width - 1, Height - 1), New StringFormat() With {.Alignment = StringAlignment.Center, .LineAlignment = StringAlignment.Center})
                    Case MouseState.Over
            ...
            Case InnerShade.Light
                ...
                Dim drawFont As New Font("Candara", 10, FontStyle.Regular)
                Select Case State
                    Case MouseState.None
...
Public Class xVisualGroupBox : Inherits ContainerControl
    ...
    Property Shade As InnerShade
        ...
        End Set
    End Property
    Private _CircleInnerColor As Color
    Private _CircleOuterColor As Color
    Property CircleInnercolor As Color
        Get
            Return _CircleInnerColor
        End Get
        Set(value As Color)
        ...
        End Set
    End Property
    Property CircleOuterColor As Color
        Get
            Return _CircleOuterColor
        End Get
        Set(value As Color)
            _CircleOuterColor = value
            Invalidate()
        End Set
    End Property
    Sub New()
        ...
        DoubleBuffered = True
        _CircleInnerColor = Color.Teal
        _CircleOuterColor = Color.Teal
    End Sub
    Dim TopTexture As TextureBrush = NoiseBrush({Color.FromArgb(49, 45, 41), Color.FromArgb(51, 47, 43), Color.FromArgb(47, 43, 39)})
    Dim FormInnerTexture As TextureBrush = NoiseBrush({Color.FromArgb(60, 60, 60), Color.FromArgb(56, 52, 49), Color.FromArgb(58, 55, 51)})
    Dim FormTopTexture As TextureBrush = NoiseBrush({Color.FromArgb(24, 24, 24), Color.FromArgb(58, 55, 51), Color.FromArgb(24, 24, 24)})
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        Select Case _Shade
            ...
            Case InnerShade.Dark
                ...
                Draw.InnerGlow(G, New Rectangle(1, 33, Width - 2, Height - 34), c)
        End Select
        'G.FillRectangle(New SolidBrush(_CircleOuterColor), New Rectangle(5, 5, 20, 20))
        'G.DrawRectangle(Pens.Black, New Rectangle(5, 5, 20, 20))
        G.FillEllipse(New SolidBrush(_CircleInnerColor), New Rectangle(10, 10, 10, 10))
        G.DrawEllipse(Pens.Black, New Rectangle(10, 10, 10, 10))
        Dim drawFont As New Font("Candara", 10, FontStyle.Regular)
        G.DrawString(Text, drawFont, Brushes.Black, New Rectangle(36, 4, Width - 1, 26), New StringFormat() With {.Alignment = StringAlignment.Near, .LineAlignment = StringAlignment.Center})
        G.DrawString(Text, drawFont, Brushes.White, New Rectangle(35, 3, Width - 1, 26), New StringFormat() With {.Alignment = StringAlignment.Near, .LineAlignment = StringAlignment.Center})
...
#Region " TextBox Properties"
    ...
    Property NumbersOnly As Boolean
        Get
            Return _NumbersOnly
        End Get
        ...
        With G
            ...
            Select Case _Style
                Case RoundingStyle.Normal
                    .FillPath(New SolidBrush(_BaseColor), Draw.CreateRound(Base, 3))
                    Dim tg As New LinearGradientBrush(Base, Color.FromArgb(186, 188, 191), Color.FromArgb(204, 205, 209), 90S)
                    .DrawPath(New Pen(tg), Draw.CreateRound(Base, 3))
                Case RoundingStyle.Rounded
                    .DrawPath(New Pen(New SolidBrush(Color.FromArgb(132, 130, 128))), Draw.CreateRound(New Rectangle(Base.X, Base.Y + 1, Base.Width, Base.Height - 1), 3))

                    .FillPath(New SolidBrush(_BaseColor), Draw.CreateRound(New Rectangle(Base.X, Base.Y, Base.Width, Base.Height - 1), 3))
                    ...
                    .DrawPath(New Pen(tg), Draw.CreateRound(New Rectangle(Base.X, Base.Y, Base.Width, Base.Height - 1), 3))
            End Select
        End With
...
#End Region
    ...
    Dim InnerTexture As TextureBrush = NoiseBrush({Color.FromArgb(32, 32, 32), Color.FromArgb(40, 40, 40), Color.FromArgb(24, 24, 24)})
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        Dim B As New Bitmap(Width, Height)
        Dim G As Graphics = Graphics.FromImage(B)
        ...
        If Checked Then
            'G.DrawString("a", New Font("Marlett", 12, _FontStyle), Brushes.White, New Point(1, 2))
            G.FillEllipse(Brushes.White, New Rectangle(5, 5, Height - 11, Height - 11))
        End If

        Dim drawFont As New Font("Candara", 10, _FontStyle)
...
#End Region
    ...
    Dim InnerTexture As TextureBrush = NoiseBrush({Color.FromArgb(32, 32, 32), Color.FromArgb(40, 40, 40), Color.FromArgb(53, 50, 46)})
...
Public Class xVisualTabControl : Inherits TabControl
    ...
    Protected Overrides Sub OnResize(ByVal e As System.EventArgs)
        MyBase.OnResize(e)
    End Sub
    Private _Alignment As TabAlignment = TabAlignment.Left
    Property TabpageAlignment As TabAlignment
        Get
            Return _Alignment
        End Get
...
#End Region
    ...
    End Sub
    Dim TopTexture As TextureBrush = NoiseBrush({Color.FromArgb(32, 32, 32), Color.FromArgb(40, 40, 40), Color.FromArgb(24, 24, 24)})
    Dim CheckTexture As TextureBrush = NoiseBrush({Color.FromArgb(225, 225, 220), Color.FromArgb(125, 175, 200), Color.FromArgb(100, 100, 120)})
    Dim InnerTexture As TextureBrush = NoiseBrush({Color.FromArgb(55, 52, 48), Color.FromArgb(57, 50, 50), Color.FromArgb(53, 50, 46)})
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        Dim B As New Bitmap(Width, Height)
        Dim G As Graphics = Graphics.FromImage(B)
        ...
        G.FillRectangle(TopTexture, radioBtnRectangle)
        ...
        If Checked Then
            G.DrawString("a", New Font("Marlett", 14, FontStyle.Regular), Brushes.White, New Point(0, 1))
            'G.FillRectangle(CheckTexture, radioBtnRectangle.X + 5, radioBtnRectangle.Y + 5, 10, 10)
            'G.DrawRectangle(New Pen(Color.FromArgb(99, 97, 94)), radioBtnRectangle.X + 4, radioBtnRectangle.Y + 4, 12, 12)
        End If
...
Public Class xVisualLabel
    ...
    Sub New()
        MyBase.New()
        _BaseColor = Color.FromArgb(32, 32, 32)
    End Sub
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        G.DrawString(Text, Font, GetBrush(Color.FromArgb(109, 109, 110)), New Rectangle(0, 0, Width - 1, Height - 1), New StringFormat() With {.Alignment = StringAlignment.Center, .LineAlignment = StringAlignment.Center})

    End Sub
End Class

Public Class xVisualNumericUpDown
   ...
   Private _isMandatory As [Boolean] = False
    Private _mandatoryBackColor As Color = Color.LightBlue
    Private _backColor As Color = Color.FromKnownColor(KnownColor.Window)

    <DefaultValue(GetType(Color), "Window"), Description("Overridden property")> _
    ...
    <DefaultValue(GetType(Color), "LightBlue"), Category("Appearance")> _
    Public Property MandatoryBackColor() As Color
        Get
            Return _mandatoryBackColor
        End Get
        Set(value As Color)
    ...
    Private Sub MyResetColors()
        MyBase.BackColor = (If(Me.IsMandatory, Me.MandatoryBackColor, Me.BackColor))
    End Sub
End Class

Class FormOverlay

    Private overlayControl As FormOverlayControl
    ...
    Public Property Image As Image
        Get
            Return overlayControl.Image
        End Get
        Set(value As Image)
            overlayControl.Image = value
        End Set
    End Property

    Public ReadOnly Property ImageSize As Size
        Get
            Return overlayControl.PictureBox.Size
        End Get
    End Property

    Public Property ParentForm As Form
        Get
            Return overlayControl.ParentForm
        End Get
        Private Set(value As Form)
            overlayControl.ParentForm = value
        End Set
    End Property

    Sub New(parentForm As Form)

        overlayControl = New FormOverlayControl(parentForm)

        Me.ParentForm = parentForm

    End Sub

    Sub New(parentForm As Form, image As Image)

        Me.New(parentForm)

        overlayControl.Image = image

    End Sub

    Public Sub Disable()
        If ParentForm.Contains(overlayControl) Then ParentForm.Controls.Remove(overlayControl)
    End Sub

    Public Sub Enable()
        If Not ParentForm.Contains(overlayControl) Then
            ParentForm.Controls.Add(overlayControl)
            overlayControl.BringToFront()
        End If
    End Sub

    Private Class FormOverlayControl
        Inherits Control

        Public PictureBox As PictureBox

        Private clientImage As Image
        ...
        Public Property Image As Image
            ...
            Set(value As Image)
                ...
                PictureBox.Location = New Point((Width / 2) - (PictureBox.Width / 2), (Height / 2) - (PictureBox.Height / 2))
            End Set
        End Property
        ...
        Sub New(parentForm As Form)
            ...
            clientImage = GetClientImage()

        End Sub

        Protected Overrides Sub OnCreateControl()
            If Not Controls.Contains(PictureBox) Then Controls.Add(PictureBox)
            MyBase.OnCreateControl()
        End Sub

        Protected Overrides Sub OnPaint(e As PaintEventArgs)

            e.Graphics.DrawImage(clientImage, 0, 0)

            Using overlayBrush As New SolidBrush(Color.FromArgb(180, Color.Black))
                e.Graphics.FillRectangle(overlayBrush, boundsRect)
            End Using
        ...
        Private Function GetClientImage() As Bitmap

            Dim bmp As New Bitmap(ParentForm.Width, ParentForm.Height)
            Dim clientRect As Rectangle = RectangleToScreen(ParentForm.ClientRectangle)

            Using g As Graphics = Graphics.FromImage(bmp)
                g.CopyFromScreen(ParentForm.Location.X + clientRect.X, ParentForm.Location.Y + clientRect.Y, 0, 0, ParentForm.Size, CopyPixelOperation.SourceCopy)
            End Using
